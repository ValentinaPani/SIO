...
<body>
	...
	<h1>SDO</h1>
	<h2>Scheda di dimissione ospedaliera</h2>
...
<div class="row">
		<div class="col-md-6 mb-3">
				...
				<select class="form-control" id="exampleFormControlSelect2">
					...
					<option>Bronchite</option>
					<option>Calcolosi</option>
		            <option>Emorragia cerebrale</option>
                    <option>Epilessia</option>
        </select>
		</div>
		
		<div class="col-md-6 mb-3">
				<label for="validationCustom05">Intervento/Procedura principale</label>
				<select class="form-control" id="exampleFormControlSelect2">
					<option>Appendicectomia</option>
					<option>Posizionamento del doppio J</option>
					<option>Stabilizzazione della colonna</option>
					<option>Posizionamento stent</option>
		            <option>Drenaggio percutaneo</option>
		...
		<div class="row">
			...
			<div class="col-md-6 mb-3">
				...
				<select class="form-control" id="exampleFormControlSelect2">
					...
					<option>Dimesso contro la volontà dei medici</option>
